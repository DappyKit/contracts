...
describe('FilesystemChanges', function () {
  ...
  describe('initialize', function () {
    it('should not initialize more than once', async function () {
      ...
      await expect(filesystemChanges.initialize(owner.address)).to.eventually.be.rejectedWith('VM Exception while processing transaction: reverted with custom error \'InvalidInitialization()')
    })
  })

  describe('setServiceChange', function () {
  ...
  describe('setUserChange', function () {
